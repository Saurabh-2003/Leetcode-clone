    ...
    <div className='flex shadow-sm py-2 justify-between bg-white min-h-10 w-full px-20 items-center'>
      <div className='flex gap-8 items-center'>
        ...
        <ul className='flex gap-6 text-gray-500 ml-4'>
          ...
          <li>Contest</li>
          <li>Discuss</li>
          <li className='flex gap-2 items-center'>Interview <FaChevronDown size={12}/></li>
          <li className='flex gap-2 text-yellow-500 items-center'>Store <FaChevronDown size={12}/></li>
        </ul>
      </div>
